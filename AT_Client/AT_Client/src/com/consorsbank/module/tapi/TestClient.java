...
import net.joras.sharesEx.calcEx.YieldRiskCalculatorEx;
...
public class TestClient implements Closeable {
 ...
 //   	String wkn = "899744"; // Realty Income
   // 	String wkn = "A1JRLA"; // American Tower
    ...
    //	String wkn = "A1T7LU"; // T-Mobile US
    //	String wkn = "A14U5Z"; // Monster
   ...
   // 	String wkn = "A1JTC1"; // Easyjet
    ...
    //	String wkn = "A14KEB"; // Home24
     ...
     int days = 4000;
    	...
    	Date tenyearsback = cal.getTime();
    	
    	System.out.println("Kurs vor 10 Jahren: " + pricesAll.get(dateFormat.format(tenyearsback)));
    	
       	
    	List<Double> einstand = new ArrayList<Double>(); // TODO: Einstand muss über 1 JAhr gerechnet werden
		einstand.add(pricesAll.get(dateFormat.format(tenyearsback)));
		
		Double geopak = yrc.geoPAK(pricesAll.get(dateFormat.format(yesterday)), einstand, 10);
		System.out.println("geoPAK10: " + geopak);
